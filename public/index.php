...
<head>
    ...
    <meta name="description" content="Página principal de compra de camisetas con etiqueta AR.">
    <title>Tienda AR</title>
</head>
...
<body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
            <h1 class="zoom text-principal display-4 font-weight-normal">AR T-shirts</h1>
            <p class="text-descripcion lead font-weight-normal">Describir que las camisas tienen diseños de R.A. </p>
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
        <div class="zoomprod bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
            <div class="my-3 py-3">
                <h2 class="display-5">Nombre Camiseta</h2>
                <p class="lead">Breve descripción del dibujo de R.A. que hay en la camiseta</p>
            </div>
            <img class="bg-light shadow-sm mx-auto" src="images/ejcamisa.jpg" width="80%" height="300px">
            </img>
        </div>
        <div class="zoomprod bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            <div class="my-3 p-3">
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
        ...
        <div class="zoomprod bg-secondary mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
            <div class="my-3 py-3">
                <h2 class="display-5">Another headline</h2>
                <p class="lead">And an even wittier subheading.</p>
            </div>
    ...
    <script src="js/web_analytics.js"></script>
    <!-- <script>
