...
<head>
    ...
    <meta name="description" content="Página destinada para el inicio de sesión.">
...
<body>
    ...
    <div class="cn">
        <div id="loggedOut" class="text-center my-4 form-signin">
            ...
            <div class="checkbox mb-3">
                <label>
                    <input id="checkbox" type="checkbox" value="remember-me"> Recuérdame
                </label>
            </div>
            <button onclick="login()" id="btnLogin" class="btn btn-lg btn-acceder btn-block"
                type="submit">Acceder</button>
            <a href="register.html" class="btn btn-lg btn-registro btn-block">Registrarse</a>
            <br>
        </div>
